...
class TestShowNotificationInit:
    ...
    def test_get_supported_tools(self, tmp_path):
        ...
        assert "notification_show" in actions
        assert "notification_show_modal" in actions
...
class TestNotificationExecution:
    ...
    async def test_execute_system_notification_success(self, tmp_path):
        ...
        result = await plugin.execute("notification_show", {
            "title": "Test Title",
    ...
    async def test_execute_modal_notification(self, tmp_path):
        ...
        result = await plugin.execute("notification_show_modal", {
            "title": "Modal Test",
...
class TestConfiguration:
    ...
    async def test_custom_default_title_from_config(self, tmp_path):
        ...
        await plugin.execute("notification_show", {
            "message": "Test"
        })
