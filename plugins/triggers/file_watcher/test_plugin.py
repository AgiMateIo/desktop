...
class TestEventEmission:
    ...
    def test_emit_file_event(self, tmp_path):
        ...
        assert event.event_name == "file_created"
    ...
    def test_emit_file_event_different_types(self, tmp_path):
        ...
        assert events_received[0].event_name == "file_created"
        assert events_received[1].event_name == "file_modified"
        assert events_received[2].event_name == "file_deleted"
        assert events_received[3].event_name == "file_moved"
