            ...
            "buttons": [
                {
                    ...
                    "trigger_name": "button_1",
                    "type": "direct",
                    "params": {}
                },
                {
                    "button_name": "Button 2",
                    "trigger_name": "button_2",
                    "type": "dialog",
                    "params": {},
                    "dialog_params": {
                        "input_label": "Input",
...
class TestEventEmission:
    ...
    def test_emit_button_event(self, tmp_path):
        ...
        # Emit event
        plugin.emit_event("button_test", {"button": "test"})

        assert len(events_received) == 1
        assert events_received[0].event_name == "button_test"
